...
//            ],
    ...
    public function actionIndex()
    {
        ...
        $news = News::find()->orderBy(['date' => SORT_DESC])->limit(1)->one();
        $newstop = News::find()->orderBy(['date' => SORT_DESC])->limit(2)->all();
        $gallery = Gallery::find()->where(['status' => 10])->orderBy(['id' => SORT_DESC])->limit(12)->all();
    ...
    {
        $about = About::find()->orderBy(['id' => SORT_ASC])->limit(1)->one();
        return $this->render('about', [
            'about' => $about
        ]);
    }

    public function actionTashkilot()
    {
    ...
    public function actionVazifalar()
    {
        return $this->render('vazifalar', [

        ]);
    }

    public function actionXokimlik()
    {
        return $this->render('xokimlik', [

        ]);
    }

    public function actionRaxbariyat()
    {
        $meeting = Meeting::find()->all();
        $members = Members::find()->all();
        return $this->render('raxbariyat', [
            'members' => $members,
             'meeting' => $meeting
        ]);
    }

    public function actionFuqarolar()
    {
        return $this->render('fuqarolar', [
